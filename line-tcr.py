...
#-----------------------------------------------
            ...
            elif msg.text in ["Sakau say hi"]:
                ki.sendText(msg.to,"Hi semuanya 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"Hi semuanya 􀜁􀅔Har Har􏿿")
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Selamat datang di Sakau Bot Family Room")
